  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a class="btn" href="javascript:;" @click="payMsgbox">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
          ...
          <div class="step-cont">
            <span>
              <el-button href="weixinpay.html" target="_blank">微信支付</el-button>
            </span>
            <span>中国银联</span>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      async payMsgbox() {
        ...
        this.$msgbox.alert(`<img src=${result} />`, '请微信支付', {
          confirmButtonText: '已支付成功',
          center: true,
          showCancelButton: true,
          dangerouslyUseHTMLString: true,
          callback: (type,item,done) => {
            if(type=='cancel'){
              alert('请联系管理员')
        ...
        if(!this.timmer){
          this.timmer=setInterval(()=>{
            // 发请求获取用户支付状态
            let result= this.$API.reqGetPayState(this.orderId);
            if(result.code==200){
              clearInterval(this.timmer);
              this.timmer=null;
